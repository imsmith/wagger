...
config :wagger, Wagger.Repo,
  database: Path.expand("../wagger_dev.db", __DIR__),
  pool_size: 5,
  stacktrace: true,
...
config :wagger, WaggerWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/wagger_web/router\.ex$"E,
      ~r"lib/wagger_web/(controllers|live|components)/.*\.(ex|heex)$"E
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :wagger, dev_routes: true
